...
export default function VolumeControlGroup({ commands }: Props) {
  return (
    <div className="ctrl-col" style={{ maxHeight: 180 }}>
      <CommandButtonIfExists commands={commands} button={RemoteButton.VolumeUp} />
      <CommandButtonIfExists commands={commands} button={RemoteButton.Mute} />
      <CommandButtonIfExists commands={commands} button={RemoteButton.VolumeDown} />
    </div>
  );
}
